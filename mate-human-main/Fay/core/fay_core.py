...
# ========== 肢体动作关键词映射配置 ==========
# 动作编号说明（Haru模型）：
# 动作编号 1-26 对应 haru_g_m01 ~ haru_g_m26（MotionNo 为 0 表示无匹配）

KEYWORD_MOTION_MAP = {
    # ========== 问候类 ==========
    "你好|您好|欢迎|hello|hi|哈喽|嘿|嗨": 1,                     # m01: 点头问候
    "你好呀|嗨|hello there|你好嘛|大家好|各位好": 5,             # m05: 热情挥手
    "早|早上好|上午好|下午好|晚上好": 1,                        # m01: 日常问候
    "欢迎光临|欢迎回来|欢迎欢迎": 21,                            # m21: 邀请手势

    # ========== 告别类 ==========
    "再见|拜拜|bye|再见啦|goodbye|byebye": 10,                   # m10: 挥手告别
    "走了|离开了|先走了|下次见": 10,                             # m10: 告别
    "晚安|早上见|明天见": 10,                                    # m10: 道别

    # ========== 肯定/赞同类 ==========
    "是的|对|正确|好的|嗯|没错|当然|是的呀": 1,                   # m01: 点头确认
    "没问题|收到|明白了|OK|ok|ok了|了解": 3,                     # m03: 微笑赞同
    "好的|行|可以|同意|同意的|就这么办": 4,                       # m04: 开心同意
    "好的呢|可以呀|没问题哒|好哒": 9,                            # m09: 愉快同意
    "就是|正是|确实|必须|绝对是": 1,                             # m01: 强调肯定
    "有道理|说得对|你说得对|认同": 1,                            # m01: 认同

    # ========== 否定类 ==========
    "不是|不对|错误|不|没有|no|nono": 2,                          # m02: 不同意/摇头
    "不行|不可以|不能|别|不要|no way": 7,                         # m07: 皱眉拒绝
    "不是的|不对呀|没有呀|怎么会": 2,                             # m02: 委婉否定
    "不行呀|不可以呀|不能呢": 7,                                  # m07: 拒绝
    "未必|不一定|不见得|不太好说": 12,                            # m12: 疑惑否定

    # ========== 思考类 ==========
    "让我想想|思考一下|想一想|考虑|想想|我想想": 11,              # m11: 思考
    "嗯...|嗯嗯|这个嘛|怎么说呢|怎么说": 11,                      # m11: 思考中
    "考虑一下|考虑考虑|需要想想": 11,                             # m11: 考虑
    "我不知道|我不清楚|不确定|不太清楚|不太确定": 12,             # m12: 困惑

    # ========== 道歉类 ==========
    "抱歉|对不起|不好意思|请原谅|道歉": 16,                       # m16: 鞠躬道歉
    "对不起啦|抱歉啦|不好意思啦|对不起哦": 17,                    # m17: 诚恳道歉
    "是我的错|我错了|怪我|都怪我": 16,                             # m16: 承认错误
    "别生气|别介意|别放在心上": 17,                               # m17: 安慰

    # ========== 惊讶/震惊类 ==========
    "哇|天啊|真的吗|什么|竟然|居然": 13,                          # m13: 惊讶欢呼
    "不会吧|天哪|我的天|真的假的": 14,                            # m14: 震惊
    "什么？|啊？|真的？|天啊！": 13,                               # m13: 惊讶
    "天哪|my god|omg|我的妈呀": 14,                               # m14: 非常震惊
    "难以置信|不敢相信|怎么会这样": 14,                           # m14: 难以置信

    # ========== 胜利/庆祝/开心类 ==========
    "成功|完成|做到了|太棒了|厉害|赢了": 6,                       # m06: 庆祝
    "耶|万岁|太好了|棒极了|优秀|太赞了": 13,                      # m13: 欢呼
    "不错|挺好|还可以|蛮好|不赖": 4,                              # m04: 开心
    "好耶|太棒啦|成功啦|做到了耶": 6,                              # m06: 庆祝成功
    "完美|绝妙|精彩|太完美了|满分": 6,                             # m06: 赞赏
    "激动|兴奋|开心死了|高兴死了": 13,                             # m13: 兴奋欢呼

    # ========== 沮丧/失望类 ==========
    "唉|糟糕|完蛋|不行|失败": 8,                                  # m08: 摇头失望
    "难过|伤心|失落|遗憾|可惜": 15,                                # m15: 沮丧
    "真遗憾|太可惜了|好可惜呀": 15,                                # m15: 遗憾
    "好难过|好伤心|好失落|唉...": 15,                              # m15: 伤心
    "失败|输了|搞砸了|弄砸了": 8,                                  # m08: 失败

    # ========== 疑问/疑惑类 ==========
    "什么？|怎么|为什么|咋|为啥": 12,                              # m12: 困惑
    "啊？|嗯？|什么？|咋了": 18,                                   # m18: 疑问
    "为什么|为何|怎么|咋样|怎么样": 18,                            # m18: 询问
    "真的吗|是吗|真的假的|你说呢": 12,                             # m12: 怀疑
    "怎么回事|怎么了|发生什么了": 18,                              # m18: 询问情况

    # ========== 感谢类 ==========
    "谢谢|感谢|多谢|Thank|感谢你|谢谢你": 17,                      # m17: 感谢
    "非常感谢|万分感谢|太感谢了|谢啦": 17,                         # m17: 诚挚感谢
    "谢谢啦|感谢啦|多谢啦|谢了": 9,                                # m09: 轻松感谢
    "感激不尽|不胜感激|太感激了": 17,                              # m17: 深情感谢

    # ========== 等待类 ==========
    "等一下|稍等|wait|稍后|等会|等等": 19,                         # m19: 等待
    "稍等一下|等一会儿|马上|稍等片刻": 19,                         # m19: 让人等待
    "请稍等|请稍候|请稍等一下": 19,                                 # m19: 礼貌等待

    # ========== 邀请/欢迎类 ==========
    "请|请进|进来|欢迎光临|快请进": 21,                            # m21: 邀请
    "来吧|一起来|跟我来|这边请|请坐": 21,                          # m21: 邀请动作
    "欢迎|欢迎欢迎|热烈欢迎": 1,                                   # m01: 欢迎点头
    "快进来|进来坐|请进请进": 21,                                  # m21: 热情邀请

    # ========== 解释/说明类 ==========
    "也就是说|换句话说|意思是|即": 22,                             # m22: 解释
    "简单说|简单来说|简单点|简单来说就是": 23,                     # m23: 简化说明
    "其实|实际上|事实上|其实呢": 22,                                # m22: 解释
    "具体来说|具体点|详细说": 23,                                  # m23: 详细说明
    "举个例子|比如|例如|比方说": 23,                                # m23: 举例说明

    # ========== 建议/推荐类 ==========
    "建议|推荐|你可以试试|试试看": 24,                             # m24: 推荐
    "最好|应该|可以试试|我建议": 24,                                # m24: 给出建议
    "试一试|试试吧|可以试试看": 24,                                # m24: 建议尝试
    "推荐你|推荐一下|我觉得你可以": 24,                            # m24: 个人推荐

    # ========== 警告/提醒类 ==========
    "注意|小心|提醒|警告|要注意": 25,                              # m25: 警告
    "小心点|注意安全|要小心|警告你": 25,                           # m25: 严肃警告
    "提醒你|告诉你|跟你说": 20,                                    # m20: 提醒
    "别忘了|记得|千万不要|一定要注意": 25,                         # m25: 重要提醒

    # ========== 总结/结束类 ==========
    "总之|总的来说|总之就是|简而言之": 26,                         # m26: 总结
    "所以|因此|综上": 26,                                          # m26: 总结
    "就这样|就是这样|结束|完了": 26,                               # m26: 结束话题
    "最后|最后一点|最后想说": 26,                                  # m26: 最后总结

    # ========== 理解/明白类 ==========
    "我懂了|我明白了|我理解了|原来如此": 3,                        # m03: 明白微笑
    "懂了|了解了|知道了|清楚": 3,                                  # m03: 了解
    "哦|噢|原来是这样|怪不得": 3,                                  # m03: 恍然大悟
    "我懂|明白|了解|清楚啦": 9,                                    # m09: 轻松明白

    # ========== 喜爱/喜欢类 ==========
    "喜欢|爱|热爱|最爱|很爱": 4,                                   # m04: 开心喜欢
    "好喜欢|超级喜欢|特别喜欢|最爱了": 4,                          # m04: 非常喜欢
    "我很喜欢|我挺喜欢|我爱": 4,                                   # m04: 表达喜欢

    # ========== 认同/称赞类 ==========
    "厉害|牛|强|佩服|太厉害了": 6,                                  # m06: 赞赏
    "优秀|出色|卓越|了不起|太牛了": 6,                              # m06: 高度赞赏
    "真厉害|真牛|真棒|真强": 6,                                     # m06: 称赞
    "佩服|佩服佩服|五体投地": 6,                                   # m06: 佩服

    # ========== 关心/问候类 ==========
    "怎么了|发生什么|还好吗|没事吧": 5,                             # m05: 关心
    "你还好吧|你怎么样|还好吗": 5,                                  # m05: 问候状况
    "别担心|没事|不要紧|放心": 9,                                  # m09: 安慰

    # ========== 请求/祈求类 ==========
    "麻烦|劳驾|拜托|请": 21,                                        # m21: 礼貌请求
    "拜托啦|求你了|麻烦你了": 17,                                  # m17: 诚恳请求
    "帮帮我|帮我|帮帮忙": 21,                                      # m21: 请求帮助

    # ========== 承诺/保证类 ==========
    "一定|肯定|绝对|保证|放心吧": 1,                                # m01: 承诺点头
    "我保证|我承诺|一定会的": 1,                                    # m01: 保证
    "放心|不用担心|别担心": 9,                                      # m09: 让人放心

    # ========== 其他常用回应 ==========
    "嗯|哦|啊|是吗": 20,                                            # m20: 日常回应
    "哈哈|嘿嘿|嘻嘻|呵呵": 9,                                       # m09: 笑
    "嗯哼|嗯嗯|好哒|好的呀": 9,                                     # m09: 轻松回应
}
...
class FeiFei:
                ...
                if platform.system() == "Windows":
                    ...
                    try:
                        ...
                        if motion_no > 0:
                            ...
                            content["Data"]["MotionGroup"] = "TapBody"  # Haru模型的动作组为TapBody
                            util.printInfo(1, interact.data.get("user"), f"动作触发: MotionNo={motion_no}")
    ...
    def __analyze_sentiment_by_keywords(self, text):
        ...
        if '？' in text or '!' in text or '~' in text:
            sentiment += 0.3  # 疑问或感叹语气略微提升情感
        if '...' in text or '。。.' in text:
            sentiment -= 0.3  # 省略号略微降低情感
